...
public class ATP_CHALLENGERS extends Scene {

	public String session_selected_broadcaster = "ATP_CHALLENGERS";
	...
	public ScoreBug updateScoreBug(List<Scene> scenes, Match match, PrintWriter print_writer)
		...
		if (scorebug.isScorebug_on_screen() == true) {
			...
			scorebug = updategameIn(match, print_writer);
			//scorebug = populateGameScore(true, scorebug, print_writer, match, session_selected_broadcaster);
		}
		return scorebug;
	}
	public ScoreBug updategameIn(Match match, PrintWriter print_writer) {
	...
	public Object ProcessGraphicOption(String whatToProcess, Match match, TennisService tennisService,
		...
		case "POPULATE-DOUBLE_MATCHPROMO": case "POPULATE-MATCH_STATS": case "POPULATE-SPEED": case "POPULATE-FF_PLAYERPROFILE": case "POPULATE-LT_PLAYERPROFILE":
		case "POPULATE-CROSS":
			switch (whatToProcess.toUpperCase()) {
			...
			case "POPULATE-FF_PLAYERPROFILE":
				...
				populateFFPlayerProfile(print_writer, valueToProcess.split(",")[0],Integer.valueOf(valueToProcess.split(",")[1]),tennisService.getAllPlayer(),
						tennisService.getStatistics(),match, session_selected_broadcaster);
				break;
		...
		case "NAMESUPER-SP_GRAPHICS-OPTIONS": case "NAMESUPER-SP1_GRAPHICS-OPTIONS": case "NAMESUPER-DP1_GRAPHICS-OPTIONS": case "FF_PLAYERPROFILE_GRAPHICS-OPTIONS":
		case "LT_PLAYERPROFILE_GRAPHICS-OPTIONS": case "MATCH_FF_PLAYERPROFILE_GRAPHICS-OPTIONS": case "MATCH_LT_PLAYERPROFILE_GRAPHICS-OPTIONS":
		...
		case "ANIMATE-IN-SINGLE_MATCHPROMO": case "ANIMATE-IN-DOUBLE_MATCHPROMO": case "ANIMATE-MATCH_STATS": case "ANIMATE-FF_PLAYERPROFILE": case "ANIMATE-LT_PLAYERPROFILE":
		...
		case "ANIMATE-OUT":
			...
			case "ANIMATE-IN-SCOREBUG":
				...
				TimeUnit.SECONDS.sleep(1);
				updategameIn(match, print_writer);
			...
			case "ANIMATE-OUT":
				...
				case "CROSS": case "MATCH_STATS": case "SPEED": case "FF_PLAYERPROFILE": case "LT_PLAYERPROFILE":
	...
	public void AnimateInGraphics(PrintWriter print_writer, String whichGraphic) throws InterruptedException {
		...
		case "DOUBLE_LT_MATCHPROMO": case "MATCH_STATS": case "SPEED": case "FF_PLAYERPROFILE": case "LT_PLAYERPROFILE":
		case "CROSS":
			...
			if (match.getSets() != null) {
				for (int i = 0; i <= match.getSets().size() - 1; i++) {
					...
					for (int j = 0; j <= match.getSets().get(i).getGames().size() - 1; j++) {
						if (match.getSets().get(i).getGames().get(j).getGame_status().equalsIgnoreCase(TennisUtil.END) && 
								match.getSets().get(i).getGames().get(j).getGame_winner() != null) {
	...
	public void populateFFMatchResultDoubles(PrintWriter print_writer, String viz_sence_path, Match match,String selectedbroadcaster) {
		if (match == null) {
			...
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "vResults" + " SET " + "1" + "\0");
			print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "vResultsText" + " SET " + "1" + "\0");
	...
	public void populateNameSuperSP(PrintWriter print_writer, String viz_sence_path,int playerid,List<Player> Plyr,List<VariousText>vt,Match match,String selectedbroadcaster) {
		...
		for(VariousText vtext : vt) {
			if(vtext.getVariousType().equalsIgnoreCase("NameSuperSingle") && vtext.getUseThis().equalsIgnoreCase("Yes")) {
				...
				print_writer.println("-1 RENDERER*TREE*$Main*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "BENGALURU OPEN" + "\0");
			}
		}
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.png In 0.980 \0");
	}
	...
	public void populateFFPlayerProfile(PrintWriter print_writer, String viz_sence_path,int Player_id,List<Player> Player,List<Statistics> Profile ,Match match,String selectedbroadcaster) {
		
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tFirstName" + " SET " + Player.get(Player_id-1).getFirstname() + "\0");
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tLastName" + " SET " + Player.get(Player_id-1).getSurname() + "\0");
		
		if(Player.get(Player_id-1).getNationality() == null) {
			print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tCountry" + " SET " + "" + "\0");
		}else {
			print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tCountry" + " SET " + Player.get(Player_id-1).getNationality() + "\0");
		}
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "lgFlag" + " SET " + flag_path + Player.get(Player_id-1).getNationality() + TennisUtil.PNG_EXTENSION + "\0");
		
		if(match.getMatchType().equalsIgnoreCase(TennisUtil.SINGLES)) {
			if(Player.get(Player_id-1).getRankingSingle() > 0) {
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tSeed" + " SET " + Player.get(Player_id-1).getRankingSingle() + "\0");
			}else {
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tSeed" + " SET " + "" + "\0");
			}
		}else if(match.getMatchType().equalsIgnoreCase(TennisUtil.DOUBLES)) {
			if(Player.get(Player_id-1).getRankingDouble() > 0) {
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tSeed" + " SET " + Player.get(Player_id-1).getRankingDouble() + "\0");
			}else {
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tSeed" + " SET " + "" + "\0");
			}
		}
		...
		for(Statistics PP : Profile) {
			if(PP.getPlayer_id() == Player_id) {
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue1" + " SET " + PP.getAge() + "\0");
				if(PP.getHeight() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue3" + " SET " + PP.getHeight() + "cm" + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue3" + " SET " + "" + "\0");
				}
				if(PP.getTurnedPro() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue2" + " SET " + PP.getTurnedPro() + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue2" + " SET " + "-" + "\0");
				}
				if(PP.getBirthPlace() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue4" + " SET " + PP.getBirthPlace() + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue4" + " SET " + "" + "\0");
				}			
				if(PP.getPlays() != null) {
					if(PP.getPlays().contains(",")) {
						print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5A" + " SET " + PP.getPlays().split(",")[0] + "\0");
						print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5B" + " SET " + PP.getPlays().split(",")[1] + "\0");
					}else {
						print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5A" + " SET " + PP.getPlays().split(",")[0] + "\0");
						print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5B" + " SET " + "" + "\0");
					}
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5A" + " SET " + "" + "\0");
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue5B" + " SET " + "" + "\0");
				}
				
//				if(PP.getTitles() != null) {
//					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tTitleValue" + " SET " + PP.getTitles() + "\0");
//				}else {
//					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tTitleValue" + " SET " + "-" + "\0");
//				}
				
//				if(PP.getWin() == null && PP.getLoss() == null) {
//					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tWinLossValue" + " SET " + "-" + "\0");
//				}else {
//					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tWinLossValue" + " SET " + PP.getWin() + "-" + PP.getLoss() + "\0");
//				}
				
				print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tEarningsHead" + " SET " + "EARNINGS" + "\0");
				if(PP.getEarnings() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tEarningsValue" + " SET " + PP.getEarnings() + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tEarningsValue" + " SET " + "-" + "\0");
				}
			}
		}
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.png In 2.000 \0");
	}
	public void populateLtPlayerProfile(PrintWriter print_writer, String viz_sence_path,int Player_id,List<Player> Player,List<Statistics> Profile ,Match match,String selectedbroadcaster) {
		...
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatHead1" + " SET " + "AGE" + "\0");
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatHead2" + " SET " + "TURNED PRO" + "\0");
		print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatHead3" + " SET " + "EARNINGS" + "\0");
		...
		for(Statistics PP : Profile) {
			if(PP.getPlayer_id() == Player_id) {
				...
				if(PP.getPlays() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "PLAYS : " +PP.getPlays() + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tInfo" + " SET " + "" + "\0");
				}
				
				if(PP.getEarnings() != null) {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue3" + " SET " + PP.getEarnings() + "\0");
				}else {
					print_writer.println("-1 RENDERER*TREE*$object*FUNCTION*ControlObject*in SET ON " + "tStatValue3" + " SET " + "-" + "\0");
				}
			}
		}
		print_writer.println("-1 RENDERER PREVIEW SCENE*" + viz_sence_path + " C:/Temp/Preview.png In 1.100 \0");
	}

...
public class ScoreBug {
	...
	public boolean game_header_on_screen = false;
	...
	public boolean isGame_header_on_screen() {
		return game_header_on_screen;
	}
	public void setGame_header_on_screen(boolean game_header_on_screen) {
		this.game_header_on_screen = game_header_on_screen;
	}
